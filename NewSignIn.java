...
String sql = "select * from userTable where userr = '"+user.getText()+"' and passWordd = '"+passWord.getText()+"'";
...
sql = "insert into userTable (userr,passWordd) values('"+user.getText()+"','"+passWord.getText()+"')";
